...
public class OntoUMLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == XcorePackage.eINSTANCE)
			...
			case XcorePackage.PACKAGE:
				sequence_Package(context, (it.unibz.inf.ontouml.xtext.xcore.Package) semanticObject); 
				return; 
			}
	 ...
	 *
	 * Constraint:
	 *     (name=ID alias=STRING? superclass=[OntoUMLClass|QualifiedName] subclass=[OntoUMLClass|QualifiedName])
	 */
	 ...
	 *
	 * Constraint:
	 *     (_type=EndurantType name=ID alias=STRING?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID alias=STRING? contents+=ModelElement)
	 */
	protected void sequence_Package(ISerializationContext context, it.unibz.inf.ontouml.xtext.xcore.Package semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}

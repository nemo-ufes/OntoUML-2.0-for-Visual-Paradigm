 ...
 * </p>
 * <ul>
 *   <li>{@link it.unibz.inf.ontouml.xtext.xcore.impl.PackageImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageImpl extends ModelElementImpl implements it.unibz.inf.ontouml.xtext.xcore.Package {
	/**
	...
	public EList<ModelElement> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<ModelElement>(ModelElement.class, this, XcorePackage.PACKAGE__CONTENTS);
		}
		return contents;
	}
	 ...
	 * @generated
	 */
	public EList<ModelElement> getAllContents() {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XcorePackage.PACKAGE__CONTENTS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case XcorePackage.PACKAGE___GET_ALL_CONTENTS:
